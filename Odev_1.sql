-- film tablosundan title ve description sütunlarındaki verileri getiren kod satırı
select title, description from film;

 -- film tablosunda bulunan tüm sütunlardaki verileri film uzunluğu (length) 60 dan büyük VE 
